<?php
	...
	$title="Editar Presupuesto | Sundac INC";
	...
	if (isset($_GET['id_presupuesto']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, presupuesto_sundac_inc.id_vendedor, presupuesto_sundac_inc.fecha_presupuesto, presupuesto_sundac_inc.condiciones, presupuesto_sundac_inc.estado_presupuesto, presupuesto_sundac_inc.numero_presupuesto,presupuesto_sundac_inc.fecha_vencimiento,presupuesto_sundac_inc.bs,presupuesto_sundac_inc.moneda,presupuesto_sundac_inc.comentario";
		$sql_presupuesto=mysqli_query($con,"select $campos from presupuesto_sundac_inc, clientes where presupuesto_sundac_inc.id_cliente=clientes.id_cliente and id_presupuesto='".$id_presupuesto."'");
		...
		{
			header("location: presupuesto_sundac_inc.php");
			exit;	
		}
	} 
	else 
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			<form class="form-horizontal" role="form" id="datos_presupuesto_sundac_inc">
			...
			<div class="clearfix"></div>
				<div class="editar_presupuesto_sundac_inc" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_presupuesto_sundac_inc.js"></script>
