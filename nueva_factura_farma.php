<?php
	...
	$title="Nueva Factura | FarmaSmart";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva Factura FarmaSmart</h4>
		</div>
					...
					<label for="estado_factura" class="col-md-1 control-label">Estado</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								...
								<option value="3" selected>Suministros Farma Smart</option>
								</select>
							</div>						
	...
	<script type="text/javascript" src="js/nueva_factura_farma.js"></script>              
