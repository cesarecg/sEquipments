<?php
	...
	$sql_count=mysqli_query($con,"select * from notas_sundac_inc where id_notas='".$id_notas."'");
	...
	$sql_notas=mysqli_query($con,"select * from notas_sundac_inc where id_notas='".$id_notas."'");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_notas_sundac_inc_html.php');
