<?php
	...
	$sql_count=mysqli_query($con,"select * from presupuesto_sundac where id_presupuesto='".$id_presupuesto."'");
	...
	$sql_presupuesto=mysqli_query($con,"select * from presupuesto_sundac where id_presupuesto='".$id_presupuesto."'");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_presupuesto_sundac_html.php');
