<?php
	...
	$sql_count=mysqli_query($con,"select * from presupuesto_farma where id_presupuesto='".$id_presupuesto."'");
	...
	$sql_presupuesto=mysqli_query($con,"select * from presupuesto_farma where id_presupuesto='".$id_presupuesto."'");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_presupuesto_farma_html.php');
