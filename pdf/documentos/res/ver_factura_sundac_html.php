...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_factura_sundac, facturas_sundac where products.id_producto=detalle_factura_sundac.id_producto and detalle_factura_sundac.numero_factura=facturas_sundac.numero_factura and facturas_sundac.id_factura='".$id_factura."'");
