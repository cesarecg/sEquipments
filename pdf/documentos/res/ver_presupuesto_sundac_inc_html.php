...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 16px; font-family: arial" >
    ...
    <table cellspacing="5" align="left" style="position:absolute;top: 160px; width: 100%; font-size: 14px;">
...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_presupuesto_sundac_inc, presupuesto_sundac_inc where products.id_producto=detalle_presupuesto_sundac_inc.id_producto and detalle_presupuesto_sundac_inc.numero_presupuesto=presupuesto_sundac_inc.numero_presupuesto and presupuesto_sundac_inc.id_presupuesto='".$id_presupuesto."'");
