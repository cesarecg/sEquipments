...
<?php include("encabezado_notas_farma.php"); ?>
<br>
...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, tmp_notas_farma where products.id_producto=tmp_notas_farma.id_producto and tmp_notas_farma.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_notas_farma VALUES ('','$numero_notas','$id_producto','$cantidad','$precio_venta_r')");
...
<table cellspacing="4" align="left" style="position:absolute;top: 790px; width: 90%; text-align: right; font-size:14px;">
		...
		<tr>
            <td colspan="1" style="width :50%; text-align: left;"><strong>Email:</strong> info@sfarmasmart.com<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	ventas@sfarmasmart.com</td>
        </tr>
...
$moneda= 1;
$comentario= "";
$insert=mysqli_query($con,"INSERT INTO notas_farma VALUES (NULL,'$numero_notas','$date','$id_cliente','$id_vendedor','$condiciones','$total_notas','2','$bs','$moneda','$comentario')");
$delete=mysqli_query($con,"DELETE FROM tmp_notas_farma WHERE session_id='".$session_id."'");
?>