	...
	<table cellspacing="5" align="right" style="position:absolute;top: 196px; width: 50%;">
        ...
        <tr> 
			<td style="width: 50%; text-align:center;">
             ...
             <br>
			 <strong> N/E Nro: <br><br> </strong> <?php echo $numero_notas;?>
...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_notas_farma, notas_farma where products.id_producto=detalle_notas_farma.id_producto and detalle_notas_farma.numero_notas=notas_farma.numero_notas and notas_farma.id_notas='".$id_notas."'");
