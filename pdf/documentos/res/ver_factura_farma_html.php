...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_factura_farma, facturas_farma where products.id_producto=detalle_factura_farma.id_producto and detalle_factura_farma.numero_factura=facturas_farma.numero_factura and facturas_farma.id_factura='".$id_factura."'");
