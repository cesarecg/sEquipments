...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_presupuesto_farma, presupuesto_farma where products.id_producto=detalle_presupuesto_farma.id_producto and detalle_presupuesto_farma.numero_presupuesto=presupuesto_farma.numero_presupuesto and presupuesto_farma.id_presupuesto='".$id_presupuesto."'");
