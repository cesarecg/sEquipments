...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, tmp_presupuesto_sundac where products.id_producto=tmp_presupuesto_sundac.id_producto and tmp_presupuesto_sundac.session_id='".$session_id."'");
...
<tr>
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_presupuesto_sundac VALUES ('','$numero_presupuesto','$id_producto','$cantidad','$precio_venta_r')");
...
$moneda=1;
$comentario= "";
$insert=mysqli_query($con,"INSERT INTO presupuesto_sundac VALUES (NULL,'$numero_presupuesto','$date','$id_cliente','$id_vendedor','$condiciones','$total_presupuesto','2','$fecha_vencimiento','$bs','$moneda','$comentario')");
$delete=mysqli_query($con,"DELETE FROM tmp_presupuesto_sundac WHERE session_id='".$session_id."'");
?>