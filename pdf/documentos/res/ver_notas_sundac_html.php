...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, detalle_notas_sundac, notas_sundac where products.id_producto=detalle_notas_sundac.id_producto and detalle_notas_sundac.numero_notas=notas_sundac.numero_notas and notas_sundac.id_notas='".$id_notas."'");
