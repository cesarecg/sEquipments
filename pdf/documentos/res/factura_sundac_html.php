...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, tmp_facturas_sundac where products.id_producto=tmp_facturas_sundac.id_producto and tmp_facturas_sundac.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura_sundac VALUES ('','$numero_factura','$id_producto','$cantidad','$precio_venta_r')");
...
$moneda= 1;
$comentario= "";
$insert=mysqli_query($con,"INSERT INTO facturas_sundac VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','2','$bs','$moneda','$comentario')");
$delete=mysqli_query($con,"DELETE FROM tmp_facturas_sundac WHERE session_id='".$session_id."'");
?>