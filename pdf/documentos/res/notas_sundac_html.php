...
<?php include("encabezado_notas_sundac.php"); ?>
<br>
...
$sumador_iva=0;
$precio_total_i=0;
$sql=mysqli_query($con, "select * from products, tmp_notas_sundac where products.id_producto=tmp_notas_sundac.id_producto and tmp_notas_sundac.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_notas_sundac VALUES ('','$numero_notas','$id_producto','$cantidad','$precio_venta_r')");
...
$moneda= 1;
$comentario= "";
$insert=mysqli_query($con,"INSERT INTO notas_sundac VALUES (NULL,'$numero_notas','$date','$id_cliente','$id_vendedor','$condiciones','$total_notas','2','$bs','$moneda','$comentario')");
$delete=mysqli_query($con,"DELETE FROM tmp_notas_sundac WHERE session_id='".$session_id."'");
?>