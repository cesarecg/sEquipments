<?php
	...
	if (isset($_GET['id_notas']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, notas_sundac_inc.id_vendedor,notas_sundac_inc.condiciones, notas_sundac_inc.fecha_notas, notas_sundac_inc.estado_notas, notas_sundac_inc.numero_notas, notas_sundac_inc.bs, notas_sundac_inc.moneda,notas_sundac_inc.comentario";
		$sql_notas=mysqli_query($con,"select $campos from notas_sundac_inc, clientes where notas_sundac_inc.id_cliente=clientes.id_cliente and id_notas='".$id_notas."'");
		...
		{
			header("location: notas_sundac_inc.php");
			exit;	
		}
	} 
	else 
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			...
			<div class="clearfix"></div>
				<div class="editar_notas_sundac_inc" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_notas_sundac_inc.js"></script>
