<?php
	...
	$title="Nueva Nota de Entrega | Sundac C.A.";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva Nota de entrega Sundac C.A.</h4>
		</div>
					...
					<label for="estado_notas" class="col-md-1 control-label">Estado</label>
						...
						<label for="empresa" class="col-md-1 control-label">Compañia</label>
							<div class="col-md-2">
								...
								<option value="1" selected>Sundac Equipment C.A</option>
								</select>
							</div>
	...
	<script type="text/javascript" src="js/nueva_notas_sundac.js"></script>              
