<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$sql="UPDATE presupuesto_sundac SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', estado_presupuesto='".$estado_presupuesto."',fecha_vencimiento='".$fecha_vencimiento."',bs='".$bs."',moneda='".$moneda."', comentario='".$comentario."' WHERE id_presupuesto='".$id_presupuesto."'";
