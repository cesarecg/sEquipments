...
{
$insert_tmp=mysqli_query($con, "INSERT INTO tmp_facturas_sundac_inc (id_producto,cantidad_tmp,precio_tmp,session_id) VALUES ('$id','$cantidad','$precio_venta','$session_id')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_tmp=intval($_GET['id']);	
$delete=mysqli_query($con, "DELETE FROM tmp_facturas_sundac_inc WHERE id_tmp='".$id_tmp."'");
}
...
<?php
	$sumador_total=0;
	$iva1=0;
	$sql=mysqli_query($con, "select * from tmp_facturas_sundac_inc, products where products.id_producto=tmp_facturas_sundac_inc.id_producto and tmp_facturas_sundac_inc.session_id='".$session_id."'");
