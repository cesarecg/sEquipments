...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_factura_farma (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_detalle=intval($_GET['id']);	
$delete=mysqli_query($con, "DELETE FROM detalle_factura_farma WHERE id_detalle='".$id_detalle."'");
}
...
<?php
	...
	$sumador_iva=0;
	$precio_total_i=0;
	$sql=mysqli_query($con, "select * from products, facturas_farma, detalle_factura_farma where facturas_farma.numero_factura=detalle_factura_farma.numero_factura and facturas_farma.id_factura='$id_factura' and products.id_producto=detalle_factura_farma.id_producto");
	...
	$update=mysqli_query($con,"update facturas_farma set total_venta='$total_factura' where id_factura='$id_factura'");
?>
<tr>
