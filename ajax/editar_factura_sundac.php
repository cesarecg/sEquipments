<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$sql="UPDATE facturas_sundac SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', estado_factura='".$estado_factura."',fecha_factura='".$fecha_factura."', bs='".$bs."', moneda='".$moneda."', comentario='".$comentario."' WHERE id_factura='".$id_factura."'";
