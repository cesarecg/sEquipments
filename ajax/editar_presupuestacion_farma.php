...
{
$insert_tmp=mysqli_query($con,"INSERT INTO detalle_presupuesto_farma (numero_presupuesto, id_producto,cantidad,precio_venta) VALUES ('$numero_presupuesto','$id','$cantidad','$precio_venta')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_detalle=intval($_GET['id']);	
$delete=mysqli_query($con,"DELETE FROM detalle_presupuesto_farma WHERE id_detalle='".$id_detalle."'");
}
...
<?php
	...
	$sumador_iva=0;
	$precio_total_i=0;
	$sql=mysqli_query($con, "select * from products, presupuesto_farma, detalle_presupuesto_farma where presupuesto_farma.numero_presupuesto=detalle_presupuesto_farma.numero_presupuesto and  presupuesto_farma.id_presupuesto='$id_presupuesto' and products.id_producto=detalle_presupuesto_farma.id_producto");
	...
	$update=mysqli_query($con,"update presupuesto_farma set total_venta='$total_presupuesto' where id_presupuesto='$id_presupuesto'");
