...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_notas_sundac (numero_notas, id_producto,cantidad,precio_venta) VALUES ('$numero_notas','$id','$cantidad','$precio_venta')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_detalle=intval($_GET['id']);	
$delete=mysqli_query($con, "DELETE FROM detalle_notas_sundac WHERE id_detalle='".$id_detalle."'");
}
...
<?php
	...
	$sumador_iva=0;
	$precio_total_i=0;
	$sql=mysqli_query($con, "select * from products, notas_sundac, detalle_notas_sundac where notas_sundac.numero_notas=detalle_notas_sundac.numero_notas and notas_sundac.id_notas='$id_notas' and products.id_producto=detalle_notas_sundac.id_producto");
	...
	$update=mysqli_query($con,"update notas_sundac set total_venta='$total_notas' where id_notas='$id_notas'");
?>
<tr>
