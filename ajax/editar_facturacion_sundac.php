...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_factura_sundac (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_detalle=intval($_GET['id']);	
$delete=mysqli_query($con, "DELETE FROM detalle_factura_sundac WHERE id_detalle='".$id_detalle."'");
}
...
<?php
	...
	$sumador_iva=0;
	$precio_total_i=0;
	$sql=mysqli_query($con, "select * from products, facturas_sundac, detalle_factura_sundac where facturas_sundac.numero_factura=detalle_factura_sundac.numero_factura and facturas_sundac.id_factura='$id_factura' and products.id_producto=detalle_factura_sundac.id_producto");
	...
	$update=mysqli_query($con,"update facturas_sundac set total_venta='$total_factura' where id_factura='$id_factura'");
?>
<tr>
