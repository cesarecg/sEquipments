...
{
$insert_tmp=mysqli_query($con,"INSERT INTO detalle_factura_sundac_inc (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_detalle=intval($_GET['id']);	
$delete=mysqli_query($con,"DELETE FROM detalle_factura_sundac_inc WHERE id_detalle='".$id_detalle."'");
}
...
<?php
	...
	$sumador_iva=0;
	$precio_total_i=0;
	$sql=mysqli_query($con, "select * from products, facturas_sundac_inc, detalle_factura_sundac_inc where facturas_sundac_inc.numero_factura=detalle_factura_sundac_inc.numero_factura and facturas_sundac_inc.id_factura='$id_factura' and products.id_producto=detalle_factura_sundac_inc.id_producto");
	...
	$update=mysqli_query($con,"update facturas_sundac_inc set total_venta='$total_factura' where id_factura='$id_factura'");
?>
<tr>
