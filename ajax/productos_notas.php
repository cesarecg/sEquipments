			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td><?php echo $codigo_producto; ?></td>
						...
						<input type="text" class="form-control" style="text-align:right" id="cantidad_<?php echo $id_producto; ?>"  value="<?php echo $stock_producto; ?>" >
						</div></td>
						...
						<?php else : ?>
							...
							<td class='text-center'><a class='btn btn-info'href="#"><i class="glyphicon glyphicon-remove"></i>No Stock</a></td>
