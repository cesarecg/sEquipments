<?php
	...
	if (isset($_GET['id'])){
		...
		$query=mysqli_query($con, "select * from detalle_factura_farma where id_producto='".$id_producto."'");
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$stock =$row['stock'];
						$fecha_cambio=date('d/m/Y', strtotime($row['date_added']));
						...
						if ($status_producto == 1){$text_estado="En Stock"; $label_class='label-success';}
						else{$text_estado="Sin Stock"; $label_class='label-danger';}
					...
					<tr>
						...
						<td><?php echo "$";?><span class='pull-right'><?php echo number_format($precio_producto,2);?></span></td>
