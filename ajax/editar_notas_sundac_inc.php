<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$sql="UPDATE notas_sundac_inc SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', estado_notas='".$estado_notas."',fecha_notas='".$fecha_notas."', bs='".$bs."', moneda='".$moneda."', comentario='".$comentario."' WHERE id_notas='".$id_notas."'";
