...
{
$insert_tmp=mysqli_query($con, "INSERT INTO tmp_facturas_sundac (id_producto,cantidad_tmp,precio_tmp,session_id) VALUES ('$id','$cantidad','$precio_venta','$session_id')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_tmp=intval($_GET['id']);	
$delete=mysqli_query($con, "DELETE FROM tmp_facturas_sundac WHERE id_tmp='".$id_tmp."'");
}
