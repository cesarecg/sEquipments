<?php
	...
	$title="Editar Factura | FarmaSmart";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, facturas_farma.id_vendedor,facturas_farma.condiciones, facturas_farma.fecha_factura, facturas_farma.estado_factura, facturas_farma.numero_factura, facturas_farma.bs, facturas_farma.moneda,facturas_farma.comentario";
		$sql_factura=mysqli_query($con,"select $campos from facturas_farma, clientes where facturas_farma.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
		...
		{
			header("location: facturas_farma.php");
			exit;	
		}
	} 
	else 
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Factura FarmaSmart</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura_farma">
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<a href="./guardar_descontar1.php?id=<?php echo urlencode($id_factura);?>">
			...
			<div class="clearfix"></div>
				<div class="editar_factura_farma" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_factura_farma.js"></script>
