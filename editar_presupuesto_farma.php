<?php
	...
	$title="Editar Presupuesto | FarmaSmart";
	...
	if (isset($_GET['id_presupuesto']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, presupuesto_farma.id_vendedor, presupuesto_farma.fecha_presupuesto, presupuesto_farma.condiciones, presupuesto_farma.estado_presupuesto, presupuesto_farma.numero_presupuesto,presupuesto_farma.fecha_vencimiento,presupuesto_farma.bs,presupuesto_farma.moneda,presupuesto_farma.comentario";
		$sql_presupuesto=mysqli_query($con,"select $campos from presupuesto_farma, clientes where presupuesto_farma.id_cliente=clientes.id_cliente and id_presupuesto='".$id_presupuesto."'");
		...
		{
			header("location: presupuesto_farma.php");
			exit;	
		}
	} 
	else 
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			<form class="form-horizontal" role="form" id="datos_presupuesto_farma">
			...
			<div class="clearfix"></div>
				<div class="editar_presupuesto_farma" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_presupuesto_farma.js"></script>
