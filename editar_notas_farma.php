<?php
	...
	if (isset($_GET['id_notas']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, notas_farma.id_vendedor,notas_farma.condiciones, notas_farma.fecha_notas, notas_farma.estado_notas, notas_farma.numero_notas, notas_farma.bs, notas_farma.moneda,notas_farma.comentario";
		$sql_notas=mysqli_query($con,"select $campos from notas_farma, clientes where notas_farma.id_cliente=clientes.id_cliente and id_notas='".$id_notas."'");
		...
		{
			header("location: notas_farma.php");
			exit;	
		}
	} 
	else 
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			<form class="form-horizontal" role="form" id="datos_notas_farma">
			...
			<div class="clearfix"></div>
				<div class="editar_notas_farma" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_notas_farma.js"></script>
