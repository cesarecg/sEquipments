<?php
	...
	$title="Nuevo Presupuesto | Sundac INC";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nuevo Presupuesto Sundac INC</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_presupuesto_sundac_inc">
				<div class="form-group row">
				  ...
				  <label for="estado_presupuesto" class="col-md-1 control-label">Estado</label>
							<div class="col-md-2">
					...
					<label for="rif" class="col-md-1 control-label">RIF</label>
						...
						<div class="form-group row">
							...
							<label for="tel2" class="col-md-1 control-label">Fecha V</label>
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="fecha_vencimiento" value="<?php echo date("d-m-Y");?>" >
							</div>
	...
	<script type="text/javascript" src="js/nuevo_presupuesto_sundac_inc.js"></script>
