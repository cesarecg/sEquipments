<?php
	...
	$title="Editar Factura | Sundac INC";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.rif_cliente, facturas_sundac_inc.id_vendedor,facturas_sundac_inc.condiciones, facturas_sundac_inc.fecha_factura, facturas_sundac_inc.estado_factura, facturas_sundac_inc.numero_factura, facturas_sundac_inc.bs, facturas_sundac_inc.moneda,facturas_sundac_inc.comentario";
		$sql_factura=mysqli_query($con,"select $campos from facturas_sundac_inc, clientes where facturas_sundac_inc.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
		...
		{
			header("location: facturas_sundac_inc.php");
			exit;	
		}
	} 
	else 
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Factura Sundac INC</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura_sundac_inc">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								...
								<select class="form-control input-sm" id="id_vendedor" name="id_vendedor">
									<option value="2"> Sundac Equipment INC</option>
								</select>
				...
				<div class="col-md-12">
					<div class="pull-right">						
						...
						<a href="./guardar_descontar.php?id=<?php echo urlencode($id_factura);?>">
			...
			<div class="clearfix"></div>
				<div class="editar_factura_sundac_inc" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_factura_sundac_inc.js"></script>
