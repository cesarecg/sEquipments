<?php
	...
	$title="Nueva Factura | Sundac C.A.";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva Factura Sundac C.A</h4>
		</div>
	...
	<script type="text/javascript" src="js/nueva_factura_sundac.js"></script>              
